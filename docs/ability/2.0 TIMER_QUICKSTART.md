...
4. **Just type in the chat**:
   - "set a timer for 4 minutes"
   - "timer for 10 mins"
   - "remind me in 5 minutes"
5. **Timer panel automatically opens** and timer starts!
...
- **At 3:00 remaining**: You'll hear 2 beeps (warning) + chat message
- **At 0:00**: You'll hear 3 ascending beeps (completion) + chat message

## Natural Language Timer Patterns

The system automatically detects timer requests in your chat messages:
...
1. You type a timer request in chat
2. System parses the duration (in minutes)
3. Timer is automatically created
4. Timer panel opens showing the countdown
5. You continue chatting with Meggy while timer runs
