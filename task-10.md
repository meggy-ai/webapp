...
- **Actions**:
  ...
  - Fallback to individual DB_* variables if DATABASE_URL not set
...
- [ ] DATABASE_URL and individual DB_* variables both supported
...
*Priority: HIGH - Essential for deployment flexibility and environment consistency*